...
default_common.param_api_docker_gradle_command = list_util.arr_param_to_str("sudo docker run --rm -u root -v \"$HOME\":\"$HOME\" -v \"$HOME\"/.gradle:/home/gradle/.gradle gradle:jdk11")
